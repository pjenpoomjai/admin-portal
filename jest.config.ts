...
const config: Config = {
	...
	// cacheDirectory: "/private/var/folders/qj/_vp16w1s7c7dt129t8jfdpq40000gn/T/jest_dx",
	...
	collectCoverageFrom: [
		...
		'!<rootDir>/src/middlewares/**/*.{ts,tsx}',
		'!<rootDir>/src/servers/**/*.{ts,tsx}',
	...
	moduleNameMapper: {
		...
		'^.+\\.(svg)$': '<rootDir>/testing/__mocks__/svgrMock.tsx',
